...
def equalpress():
    try:
        ...
        equation.set(" this format is wrong ")
        expression = ""
...
if __name__ == "__main__":
    ...
    multiply = Button(gui, text=' * ', fg='green', bg='black',
                      command=lambda: press("*"), height=3, width=7)
    ...
    clear_button = Button(gui, text='Clear', fg='red', bg='black',
